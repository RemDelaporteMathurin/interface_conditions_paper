...
axs[0].set_ylabel("Inventory (H m$^{-1}$)")
axs[0].legend()
...
# plot flux
plt.figure()
plt.plot(data_c['ts'], -data_c['Flux_surface_10_solute'], label=r"continuity of $c_\mathrm{m}$")
plt.plot(data_mu['ts'], -data_mu['Flux_surface_10_solute'], label="continuity of $\mu$", linestyle="dashed")
# plt.yscale("log")
plt.xscale("log")
plt.legend()
plt.xlabel("Time (s)")
